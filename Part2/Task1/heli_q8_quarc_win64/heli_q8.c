 ...
 * C source code generated on : Wed Sep 29 11:29:01 2021
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  for (i = 0; i < 2; i++) {
     ...
     */
    heli_q8_B.Sum1[i] = heli_q8_B.MatrixMultiply1[i] - ((heli_q8_P.K[i + 2] *
      heli_q8_B.PitchTransferFcn + heli_q8_P.K[i] * heli_q8_B.PitchCounttorad) +
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (799366465U);
  heli_q8_M->Sizes.checksums[1] = (1150646203U);
  heli_q8_M->Sizes.checksums[2] = (4050618946U);
  heli_q8_M->Sizes.checksums[3] = (1651302216U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (152);/* Sum of parameter "widths" */
  return heli_q8_M;
}
