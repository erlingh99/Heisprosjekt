  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_B.MatrixMultiply
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 31;
	
	  ;% heli_q8_B.MatrixMultiply1_m
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.Scope_PWORK_d.LoggedData
	  section.data(15).logicalSrcIdx = 28;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_q8_DW.Scope1_PWORK_a.LoggedData
  ...
  targMap.checksum0 = 3775226793;
  targMap.checksum1 = 3192274425;
  targMap.checksum2 = 3310147384;
  targMap.checksum3 = 4116127766;
