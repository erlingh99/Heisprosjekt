...
typedef struct {
  ...
  real_T Integrator_i[5];              /* '<S7>/Integrator' */
  real_T K_ei;                         /* '<S8>/K_ei' */
  real_T FrontmotorSaturation;         /* '<S3>/Front motor: Saturation' */
  real_T BackmotorSaturation;          /* '<S3>/Back motor: Saturation' */
  real_T Sum_h;                        /* '<S5>/Sum' */
  real_T Sum2;                         /* '<S5>/Sum2' */
  real_T MatrixMultiply[5];            /* '<S7>/MatrixMultiply' */
  real_T MatrixMultiply1_m[2];         /* '<S7>/MatrixMultiply1' */
  real_T Sum2_p[5];                    /* '<S7>/Sum2' */
} B_heli_q8_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_m[5];       /* '<S7>/Integrator' */
  real_T Integrator_CSTATE_n;          /* '<S8>/Integrator' */
} X_heli_q8_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_m[5];    /* '<S7>/Integrator' */
  boolean_T Integrator_CSTATE_n;       /* '<S8>/Integrator' */
} XDis_heli_q8_T;
...
struct P_heli_q8_T_ {
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 0.52
  ...
  real_T Frontgain_Gain;               /* Expression: 0.5
                                        ...
                                        */
  real_T Integrator_IC_ky;             /* Expression: 0
 ...
 * '<S7>'   : 'heli_q8/Simulation'
 * '<S8>'   : 'heli_q8/Elevation controller/Elevation controller'
 * '<S9>'   : 'heli_q8/Pitch controller/Subsystem'
 */
