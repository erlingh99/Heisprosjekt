...
#ifndef RTW_HEADER_heli_q8_pres22_h_
#define RTW_HEADER_heli_q8_pres22_h_
#include <string.h>
#ifndef heli_q8_pres22_COMMON_INCLUDES_
#define heli_q8_pres22_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_pres22_COMMON_INCLUDES_ */

#include "heli_q8_pres22_types.h"
...
#define heli_q8_pres22_rtModel         RT_MODEL_heli_q8_pres22_T
...
typedef struct {
  ...
  real_T MatrixMultiply1[2];           /* '<S4>/MatrixMultiply1' */
  ...
  real_T Sum;                          /* '<S4>/Sum' */
  real_T Sum2;                         /* '<S4>/Sum2' */
  real_T MatrixMultiply[5];            /* '<S5>/MatrixMultiply' */
  real_T MatrixMultiply1_m[2];         /* '<S5>/MatrixMultiply1' */
  real_T Sum2_p[5];                    /* '<S5>/Sum2' */
} B_heli_q8_pres22_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_m[5];       /* '<S5>/Integrator' */
} X_heli_q8_pres22_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_m[5];    /* '<S5>/Integrator' */
} XDis_heli_q8_pres22_T;
...
#define rtB                            heli_q8_pres22_B
#define BlockIO                        B_heli_q8_pres22_T
#define rtX                            heli_q8_pres22_X
#define ContinuousStates               X_heli_q8_pres22_T
#define rtXdot                         heli_q8_pres22_XDot
#define StateDerivatives               XDot_heli_q8_pres22_T
#define tXdis                          heli_q8_pres22_XDis
#define StateDisabled                  XDis_heli_q8_pres22_T
#define rtP                            heli_q8_pres22_P
#define Parameters                     P_heli_q8_pres22_T
#define rtDWork                        heli_q8_pres22_DW
#define D_Work                         DW_heli_q8_pres22_T

/* Parameters (default storage) */
struct P_heli_q8_pres22_T_ {
  real_T A[25];                        /* Variable: A
...
struct tag_RTM_heli_q8_pres22_T {
  const char_T *path;
...
extern P_heli_q8_pres22_T heli_q8_pres22_P;

/* Block signals (default storage) */
extern B_heli_q8_pres22_T heli_q8_pres22_B;

/* Continuous states (default storage) */
extern X_heli_q8_pres22_T heli_q8_pres22_X;

/* Block states (default storage) */
extern DW_heli_q8_pres22_T heli_q8_pres22_DW;
...
extern void heli_q8_pres22_initialize(void);
extern void heli_q8_pres22_output0(void);
extern void heli_q8_pres22_update0(void);
extern void heli_q8_pres22_output(int_T tid);
extern void heli_q8_pres22_update(int_T tid);
extern void heli_q8_pres22_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_pres22_rtModel *heli_q8_pres22(void);
...
extern RT_MODEL_heli_q8_pres22_T *const heli_q8_pres22_M;
 ...
 *
 * '<Root>' : 'heli_q8_pres22'
 * '<S1>'   : 'heli_q8_pres22/Conversion'
 * '<S2>'   : 'heli_q8_pres22/Heli 3D'
 * '<S3>'   : 'heli_q8_pres22/Joystick'
 * '<S4>'   : 'heli_q8_pres22/LQR'
 * '<S5>'   : 'heli_q8_pres22/Simulation'
 */
#endif                                 /* RTW_HEADER_heli_q8_pres22_h_ */
