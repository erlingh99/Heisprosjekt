...
#ifndef RTW_HEADER_heli_q8_pres4_h_
#define RTW_HEADER_heli_q8_pres4_h_
#include <math.h>
#include <string.h>
#ifndef heli_q8_pres4_COMMON_INCLUDES_
#define heli_q8_pres4_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_pres4_COMMON_INCLUDES_ */

#include "heli_q8_pres4_types.h"
...
#define heli_q8_pres4_rtModel          RT_MODEL_heli_q8_pres4_T
...
typedef struct {
  ...
  real_T Sum_f;                        /* '<S8>/Sum' */
  real_T Sum2_l;                       /* '<S8>/Sum2' */
  real_T x_hat[6];                     /* '<S7>/MATLAB Function2' */
  real_T P_hat[36];                    /* '<S7>/MATLAB Function2' */
  real_T x_bar[6];                     /* '<S7>/MATLAB Function' */
  real_T P_bar[36];                    /* '<S7>/MATLAB Function' */
  real_T euler_rates[3];
         /* '<Root>/Gyro vector to [pitch rate, elevation rate, travel rate]' */
  real_T y[6];                         /* '<Root>/Extract diagonal' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Elevation_dot_PWORK;               /* '<Root>/Elevation_dot' */
  ...
  struct {
    void *LoggedData;
  } Pitch_dot_PWORK;                   /* '<Root>/Pitch_dot' */

  struct {
    void *LoggedData;
  } Predictionvariance_PWORK;          /* '<Root>/Prediction variance' */
  ...
  struct {
    void *LoggedData;
  } Travel_dot_PWORK;                  /* '<Root>/Travel_dot' */
  ...
  struct {
    void *LoggedData;
  } imu_rates_PWORK;                   /* '<Root>/imu_rates' */

  struct {
    void *LoggedData;
  } imu_vals_PWORK;                    /* '<Root>/imu_vals' */

  struct {
    void *LoggedData;
  } x_hat_PWORK;                       /* '<Root>/x_hat' */
...
#define rtB                            heli_q8_pres4_B
#define BlockIO                        B_heli_q8_pres4_T
#define rtX                            heli_q8_pres4_X
#define ContinuousStates               X_heli_q8_pres4_T
#define rtXdot                         heli_q8_pres4_XDot
#define StateDerivatives               XDot_heli_q8_pres4_T
#define tXdis                          heli_q8_pres4_XDis
#define StateDisabled                  XDis_heli_q8_pres4_T
#define rtP                            heli_q8_pres4_P
#define Parameters                     P_heli_q8_pres4_T
#define rtDWork                        heli_q8_pres4_DW
#define D_Work                         DW_heli_q8_pres4_T

/* Parameters (default storage) */
struct P_heli_q8_pres4_T_ {
  ...
  real_T Q_d[36];                      /* Variable: Q_d
                                        ...
                                        */
  real_T R_d[36];                      /* Variable: R_d
                                        * Referenced by: '<S7>/Constant4'
                                        */
  real_T vs_0;                         /* Variable: vs_0
                                        * Referenced by: '<Root>/Constant3'
                                        */
  real_T x_0[6];                       /* Variable: x_0
  ...
  real_T Gain2_Gain[9];             /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                     ...
                                     */
  real_T Constant1_Value_k;            /* Expression: 0.16
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T Constant_Value_p;             /* Expression: 0.12
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Constant_Value_m;             /* Expression: 0.52
...
struct tag_RTM_heli_q8_pres4_T {
  const char_T *path;
...
extern P_heli_q8_pres4_T heli_q8_pres4_P;

/* Block signals (default storage) */
extern B_heli_q8_pres4_T heli_q8_pres4_B;

/* Continuous states (default storage) */
extern X_heli_q8_pres4_T heli_q8_pres4_X;

/* Block states (default storage) */
extern DW_heli_q8_pres4_T heli_q8_pres4_DW;
...
extern void heli_q8_pres4_initialize(void);
extern void heli_q8_pres4_output0(void);
extern void heli_q8_pres4_update0(void);
extern void heli_q8_pres4_output(int_T tid);
extern void heli_q8_pres4_update(int_T tid);
extern void heli_q8_pres4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_pres4_rtModel *heli_q8_pres4(void);
...
extern RT_MODEL_heli_q8_pres4_T *const heli_q8_pres4_M;
 ...
 *
 * '<Root>' : 'heli_q8_pres4'
 * '<S1>'   : 'heli_q8_pres4/Conversion1'
 * '<S2>'   : 'heli_q8_pres4/Extract diagonal'
 * '<S3>'   : 'heli_q8_pres4/Gyro vector to [pitch rate, elevation rate, travel rate]'
 * '<S4>'   : 'heli_q8_pres4/Heli 3D1'
 * '<S5>'   : 'heli_q8_pres4/IMU1'
 * '<S6>'   : 'heli_q8_pres4/Joystick1'
 * '<S7>'   : 'heli_q8_pres4/Kalman'
 * '<S8>'   : 'heli_q8_pres4/LQR1'
 * '<S9>'   : 'heli_q8_pres4/MATLAB Function1'
 * '<S10>'  : 'heli_q8_pres4/Plotting'
 * '<S11>'  : 'heli_q8_pres4/Kalman/MATLAB Function'
 * '<S12>'  : 'heli_q8_pres4/Kalman/MATLAB Function2'
 */
#endif                                 /* RTW_HEADER_heli_q8_pres4_h_ */
