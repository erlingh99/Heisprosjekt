...
#ifndef RTW_HEADER_heli_q8_pres1_h_
#define RTW_HEADER_heli_q8_pres1_h_
#include <math.h>
#include <string.h>
#ifndef heli_q8_pres1_COMMON_INCLUDES_
#define heli_q8_pres1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_pres1_COMMON_INCLUDES_ */

#include "heli_q8_pres1_types.h"
...
#define heli_q8_pres1_rtModel          RT_MODEL_heli_q8_pres1_T
...
#define rtB                            heli_q8_pres1_B
#define BlockIO                        B_heli_q8_pres1_T
#define rtX                            heli_q8_pres1_X
#define ContinuousStates               X_heli_q8_pres1_T
#define rtXdot                         heli_q8_pres1_XDot
#define StateDerivatives               XDot_heli_q8_pres1_T
#define tXdis                          heli_q8_pres1_XDis
#define StateDisabled                  XDis_heli_q8_pres1_T
#define rtP                            heli_q8_pres1_P
#define Parameters                     P_heli_q8_pres1_T
#define rtDWork                        heli_q8_pres1_DW
#define D_Work                         DW_heli_q8_pres1_T

/* Parameters (default storage) */
struct P_heli_q8_pres1_T_ {
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T KppS_Value;                   /* Expression: 1
                                        * Referenced by: '<S5>/KppS'
                                        */
  ...
  real_T PitchTransferFcn_D;           /* Computed Parameter: PitchTransferFcn_D
                                        * Referenced by: '<S3>/Pitch: Transfer Fcn'
                                        */
  real_T K1_Value;                     /* Expression: 0.0545992
                                        * Referenced by: '<S7>/K1'
                                        */
  real_T Constant_Value;               /* Expression: 2
                                        * Referenced by: '<S7>/Constant'
                                        */
  real_T Zeta_Value;                   /* Expression: 1
                                        * Referenced by: '<S5>/Zeta'
                                        */
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Constant_Value_a;             /* Expression: 0.52
...
struct tag_RTM_heli_q8_pres1_T {
  const char_T *path;
...
extern P_heli_q8_pres1_T heli_q8_pres1_P;

/* Block signals (default storage) */
extern B_heli_q8_pres1_T heli_q8_pres1_B;

/* Continuous states (default storage) */
extern X_heli_q8_pres1_T heli_q8_pres1_X;

/* Block states (default storage) */
extern DW_heli_q8_pres1_T heli_q8_pres1_DW;
...
extern void heli_q8_pres1_initialize(void);
extern void heli_q8_pres1_output0(void);
extern void heli_q8_pres1_update0(void);
extern void heli_q8_pres1_output(int_T tid);
extern void heli_q8_pres1_update(int_T tid);
extern void heli_q8_pres1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_pres1_rtModel *heli_q8_pres1(void);
...
extern RT_MODEL_heli_q8_pres1_T *const heli_q8_pres1_M;
 ...
 *
 * '<Root>' : 'heli_q8_pres1'
 * '<S1>'   : 'heli_q8_pres1/Conversion'
 * '<S2>'   : 'heli_q8_pres1/Elevation controller'
 * '<S3>'   : 'heli_q8_pres1/Heli 3D'
 * '<S4>'   : 'heli_q8_pres1/Joystick'
 * '<S5>'   : 'heli_q8_pres1/Pitch controller'
 * '<S6>'   : 'heli_q8_pres1/Elevation controller/Elevation controller'
 * '<S7>'   : 'heli_q8_pres1/Pitch controller/Subsystem'
 */
#endif                                 /* RTW_HEADER_heli_q8_pres1_h_ */
