...
typedef struct {
  ...
  real_T UnitDelay[7];                 /* '<S7>/Unit Delay' */
  ...
  real_T p;                            /* '<Root>/MATLAB Function1' */
  real_T x_hat[7];                     /* '<S7>/MATLAB Function2' */
  real_T P_hat[49];                    /* '<S7>/MATLAB Function2' */
  real_T x_bar[7];                     /* '<S7>/MATLAB Function' */
  real_T P_bar[49];                    /* '<S7>/MATLAB Function' */
  real_T euler_rates[3];
         /* '<Root>/Gyro vector to [pitch rate, elevation rate, travel rate]' */
  real_T y[7];                         /* '<Root>/Extract diagonal' */
  uint8_T StreamCall1_o2;              /* '<S5>/Stream Call1' */
} B_heli_q8_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T UnitDelay_DSTATE[7];          /* '<S7>/Unit Delay' */
  real_T UnitDelay1_DSTATE[49];        /* '<S7>/Unit Delay1' */
...
struct P_heli_q8_T_ {
  real_T A_d[49];                      /* Variable: A_d
                                        * Referenced by: '<S7>/Constant'
                                        */
  real_T B_d[14];                      /* Variable: B_d
                                        * Referenced by: '<S7>/Constant5'
                                        */
  real_T C_d[42];                      /* Variable: C_d
  ...
  real_T K[10];                        /* Variable: K
                                        ...
                                        */
  real_T P_0[49];                      /* Variable: P_0
                                        * Referenced by: '<S7>/Unit Delay1'
                                        */
  real_T Q_d[49];                      /* Variable: Q_d
 ...
 * '<S2>'   : 'heli_q8/Extract diagonal'
 * '<S3>'   : 'heli_q8/Gyro vector to [pitch rate, elevation rate, travel rate]'
 * '<S4>'   : 'heli_q8/Heli 3D1'
 * '<S5>'   : 'heli_q8/IMU1'
 * '<S6>'   : 'heli_q8/Joystick1'
 * '<S7>'   : 'heli_q8/Kalman'
 * '<S8>'   : 'heli_q8/LQR1'
 * '<S9>'   : 'heli_q8/MATLAB Function1'
 * '<S10>'  : 'heli_q8/Plotting'
 * '<S11>'  : 'heli_q8/Kalman/MATLAB Function'
 * '<S12>'  : 'heli_q8/Kalman/MATLAB Function2'
 */
