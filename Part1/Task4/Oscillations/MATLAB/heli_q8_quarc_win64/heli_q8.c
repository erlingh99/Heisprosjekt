 ...
 * C source code generated on : Wed Sep  8 10:48:12 2021
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_Sum_p = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_Sum_p = 0.0;
    } else {
      rtb_Sum_p = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_Start;
    }
     ...
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.Product = (heli_q8_P.Gainx_Gain * rtb_Sum_p *
                         heli_q8_P.Joystick_gain_x * heli_q8_P.Gain_Gain -
                         heli_q8_B.PitchCounttorad) * heli_q8_P.KppS_Value;
     ...
     *  Sqrt: '<S7>/Sqrt'
     */
    heli_q8_B.Product_d = sqrt(heli_q8_P.KppS_Value / heli_q8_P.K1_Value) *
      heli_q8_P.Constant_Value_l * heli_q8_P.Zeta_Value;
  }
   ...
   */
  rtb_Sum1 = heli_q8_B.Product - (heli_q8_P.PitchTransferFcn_C *
    heli_q8_X.PitchTransferFcn_CSTATE + heli_q8_P.PitchTransferFcn_D *
    heli_q8_B.PitchCounttorad) * heli_q8_B.Product_d;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Gain: '<S4>/Gain: y'
     *  Gain: '<S4>/Joystick_gain_y'
     *  Sum: '<S3>/Sum'
     */
    rtb_Sum_p = heli_q8_P.Gainy_Gain * rtb_Backgain * heli_q8_P.Joystick_gain_y
      - (heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value_a);
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Sum_p = (rtb_Backgain - rtb_Sum1) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Sum_p = (rtb_Backgain + rtb_Sum1) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  heli_q8_M->Sizes.numBlocks = (47);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (11);  /* Number of block outputs */
