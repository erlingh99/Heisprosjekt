 ...
 * C source code generated on : Wed Sep  8 12:57:40 2021
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Gain: '<S4>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_Sum_p *
     ...
     *  Sum: '<S5>/Sum'
     */
    heli_q8_B.Product = (heli_q8_P.Gain_Gain * heli_q8_B.Joystick_gain_x -
                         heli_q8_B.PitchCounttorad) * heli_q8_P.KppD_Value;
  }
   ...
   *  Product: '<S5>/Product1'
   */
  rtb_Sum2 = heli_q8_B.Product - heli_q8_B.PitchTransferFcn *
    heli_q8_P.Zeta2_Value;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value_a;
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Sum_p = (rtb_Backgain - rtb_Sum2) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Sum_p = (rtb_Backgain + rtb_Sum2) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4211141732U);
  heli_q8_M->Sizes.checksums[1] = (4026188729U);
  heli_q8_M->Sizes.checksums[2] = (2991888421U);
  heli_q8_M->Sizes.checksums[3] = (3877150678U);
